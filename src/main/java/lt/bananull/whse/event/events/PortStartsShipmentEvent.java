...
public class PortStartsShipmentEvent extends Event {
    ...
    public void execute(Simulator simulator) {
        ...
        PickDto nextAvailablePick = shipment.getNextUnpickedPick(state);
        if (nextAvailablePick != null) {
            BinRequestedAtPortEvent event = new BinRequestedAtPortEvent(
                getSimTime(),
                nextAvailablePick.binId(),
                gridId,
                portId,
                nextAvailablePick.ean(),
                nextAvailablePick.qty(),
                shipment.getId());
